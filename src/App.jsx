...
const slides = [
  ...
  // 10. Hands-on: Add Setup Instructions
  {
    id: 'hands-on-setup',
    content: () => (
      <div className="flex flex-col justify-center h-full px-8 md:px-16 max-w-5xl mx-auto">
