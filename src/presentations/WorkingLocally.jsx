          ...
          <div>
            <div className="card mb-4">
              ...
              <div className="code-block relative">
                <CopyButton text={"cd ~/Documents\ngit clone https://github.com/YOUR-NAME/commerce-agent-demo.git\ncd commerce-agent-demo"} />
    ...
    content: () => (
      <div className="flex flex-col justify-center h-full px-8 md:px-16 max-w-4xl mx-auto">
        ...
        <div className="card mb-6">
          ...
          <div className="code-block relative">
            <CopyButton text={"git commit -m \"Add live Q&A section to demo script\""} />
      ...
      <div className="flex flex-col justify-center h-full px-8 md:px-16 max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="card">
            ...
            <div className="mt-3 bg-gray-900 rounded-lg p-3 text-sm relative">
              <CopyButton text={"cd commerce-agent-demo\ngit pull"} />
